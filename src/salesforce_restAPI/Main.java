...
public class Main {
    ...
    static final String USERNAME     = "chakerfst@brave-goat-481703.com";
    static final String PASSWORD     = "brestFRANCE*197QLR9dzG3qpQB0F6GLq18CQ";
    static final String LOGINURL     = "https://login.salesforce.com";
    static final String GRANTSERVICE = "/services/oauth2/token?grant_type=password";
    static final String CLIENTID     = "3MVG9TSaZ8P6zP1qnkDQoevO2KLJVS81iqJtASP2K8auBOY.EBjqOqkkM8iP.pNtgHTbiRD1vRatNAHbJgvQT";
    static final String CLIENTSECRET = "7733955780186262720";
    ...
    public static void main(String[] args) {
        ...
        // Connect to the Salesforce server must configure the proxy
        HttpHost proxy = new HttpHost("www-cache-nrs.si.fr.intraorange", 3128, "http");
    ...
    public static void queryLeads() {
        ...
        try {
         ...
         // Login requests must be GETs
            HttpGet httpGet = new HttpGet(uri);
            System.out.println("oauthHeader2: " + oauthHeader);
            httpGet.addHeader(oauthHeader);
            httpGet.addHeader(prettyPrintHeader);
            
            // to connect to the Salesforce server must configure the proxy
            HttpHost proxy = new HttpHost("www-cache-nrs.si.fr.intraorange", 3128, "http");
    		RequestConfig config = RequestConfig.custom().setProxy(proxy).build();
    ...
    public static void deleteLeads() {
        ...
        try {
            ...
            // Login requests must be DELETEs
